...
public class MGroup {
	...
	public static String GetDeptList(String id){
		String deptList_url = GETLIST_URL;//.replace("ID", id);
		return deptList_url;
	}
	//示例
...
//		String PostData = Create("新建部门", "2");
		String PostData = GetDeptList("1");
		
		// 提交数据,获取结果
		String result = WeixinUtil.GetDepartmentList(access_token, "GET", GETLIST_URL, PostData);
